...
var testing = function(stimulus2) {
  return {
    ...
    prompt: "<p style='text-align:center'>The " + stimulus2.color + " " + stimulus2.shape + " just wugged.</p>",
...
var teachMaker = function(material) {
  var stimulus = "<p style='text-align:center'>The " + material.color + " " + material.shape + " is going to wug:</p>"
              + "<div  class = 'container2'> " + material.subject + " </div>"
