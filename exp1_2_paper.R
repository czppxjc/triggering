...
#122 in total, 49 experiment 1, 73 experiment 2
...
#49 (36 with new stricter exclusion)
length(unique(data2$subjectId))
#70 (54 with new stricter exclusion)

# no participants removed from experiment 1, 3 removed from experiment 2
